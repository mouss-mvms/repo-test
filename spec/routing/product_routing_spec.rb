...
RSpec.describe "routes for Products", :type => :routing do
  ...
  it { should route(:put, '/api/auth/shops/26/products/47671').to(controller: 'api/shops/products', action: :update, shop_id: 26, id: 47671) }
  ...
  it { should route(:put, '/api/auth/citizens/26/products/3432').to(controller: 'api/citizens/products', action: :update, id: 26, product_id: 3432) }
end