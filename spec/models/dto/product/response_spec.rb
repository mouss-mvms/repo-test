...
RSpec.describe Dto::Product::Response do

  describe 'create' do
    context 'All ok' do
      it 'should return a Dto::Product::Response' do
        product = create(:product_created_by_citizen)
        result = Dto::Product::Response.create(product)

        expect(result).to be_instance_of(Dto::Product::Response)
        ...
        expect(result.category).to be_instance_of(Dto::Category::Response)
        expect(result.variants).to eq(product.references&.map { |reference| Dto::Variant::Response.create(reference) })
  ...
  describe 'to_h' do
    context 'All ok' do
      it 'should a hash representation of Dto::Product::Response' do
        product = create(:product_created_by_citizen)
        dto = Dto::Product::Response.create(product)
