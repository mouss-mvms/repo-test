  ...
  describe 'create' do
    context 'All ok' do
      it 'should return a Dto::Schedule::Response' do
        ...
        expect(result).to be_instance_of(Dto::V1::Schedule::Response)
        expect(result.id).to eq(schedule.id)
        expect(result.day).to eq(Dto::V1::Schedule::Response.int_to_day(schedule.day))
  ...
  describe 'int_to_day' do
    context 'Int is 1' do
      it 'should return Lundi' do
        expect(Dto::V1::Schedule::Response.int_to_day(1)).to eq('Lundi')
      end
    end

    context 'Int is 2' do
      it 'should return Mardi' do
        expect(Dto::V1::Schedule::Response.int_to_day(2)).to eq('Mardi')
      end
    end

    context 'Int is 3' do
      it 'should return Mercredi' do
        expect(Dto::V1::Schedule::Response.int_to_day(3)).to eq('Mercredi')
      end
    end

    context 'Int is 4' do
      it 'should return Jeudi' do
        expect(Dto::V1::Schedule::Response.int_to_day(4)).to eq('Jeudi')
      end
    end

    context 'Int is 5' do
      it 'should return Vendredi' do
        expect(Dto::V1::Schedule::Response.int_to_day(5)).to eq('Vendredi')
      end
    end

    context 'Int is 6' do
      it 'should return Samedi' do
        expect(Dto::V1::Schedule::Response.int_to_day(6)).to eq('Samedi')
      end
    end

    context 'Int is 7' do
      it 'should return Dimanche' do
        expect(Dto::V1::Schedule::Response.int_to_day(7)).to eq('Dimanche')
      end
    end

    context 'Int is not correct' do
      it 'should return nil' do
        expect(Dto::V1::Schedule::Response.int_to_day(89)).to be_nil
      end
    end
  end
