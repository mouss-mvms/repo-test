...
RSpec.describe 'api/v1/reviews', swagger_doc: 'v1/swagger.json', type: :request do

  path '/api/v1/auth/reviews' do
    ...
    post('Create a review') do
      ...
      description 'Create a review for a product or a shop or create an answer for an existing review'
      security [{ authorization: [] }]

      parameter name: :review, in: :body, schema: {
        type: :object,
        description: 'To create a review, productId or shopId too but not both, mark is required, parentid is forbidden.
        ...
        properties: {
          ...
          productId: { type: :integer, example: 13, description: 'Product id of review' },
